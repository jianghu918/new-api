...
var auditContentTemplates = map[string]string{
	...
	"user.quota_add_batch":        "Batch increased quota by ${quota} for ${count} users",
	"user.quota_subtract_batch":   "Batch decreased quota by ${quota} for ${count} users",
	"user.quota_override_batch":   "Batch overrode quota to ${to} for ${count} users",
